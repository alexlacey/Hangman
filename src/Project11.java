 ...
 * Hangman.java
 * 
 *   A program that allows the user to play Hangman, a simple word guessing game. In this game, the user provides a list of 
...
public class Project11 {
	...
	public static void main(String[] args) throws  MalformedURLException, IOException {
		...
		ArrayList<String> wordList = importWordList(); // load the list of the 1000 most common English words (created by David Norman, available on GitHub)
	    ...
	    while (keepPlaying == true) {
	        ...
	        ArrayList<String> previousGuessList = new ArrayList<String>(); // create an ArrayList of the characters guessed by the user
	        char charGuess = ' '; // template for the character that the user will be guessing
	        boolean unsolved = true; // whether or not the word has been guessed correctly
	        
	        /* Loop through multiple iterations of guessing until the user discovers the correct answer */
	        while (unsolved == true) {
	        	printCurrentState(charGuess, solution, currentInfo, previousGuessList); // informs the user of the current information in the game
	            ...
	            if (checkInList(charGuess, charList) == true) { // if the character occurs in the solution
	                ...
	                String wordGuess = getWordGuess(in, currentInfo); // present the updated information to the user and get a guess of the word
	...
	private static void printCurrentState(char charGuess, String solution, String currentInfo, ArrayList<String> previousGuessList) {
		System.out.println();
    	System.out.println("The word to guess is: " + modifyInfo(charGuess, solution, currentInfo)); // present the user with what they know about the word so far
        System.out.print("Previous characters guessed: "); printList(previousGuessList); // prints previously-guessed characters
        System.out.println();
	}
